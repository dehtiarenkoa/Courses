...
n_l = 3
n_input = 3
weights_1 = np.array([[0.2,0.9,0.6],[0.2,0.3,0.7]])
weights_2 = np.array([[0.2, 0.5]])
x = np.array([[15],[5],[15]])
b_1 = np.array ([[0,0,0]] )
b_2 = np.array ([[0,0]] )
y_1 = np.array([[0],[0]])
...
y_2:  [[0.66818774]]
[[-0.07356705]]
delta_2 [[-0.00326215 -0.00815538]]
delta_2.shape (1, 2)
[[-1.55863107e-10 -6.98529651e-10]
 [-3.67391609e-10 -1.64653418e-09]
 [-5.23254716e-10 -2.34506383e-09]]"""